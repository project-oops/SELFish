...
fn name(tag: u64) -> String {
    ...
    let known: &[(u64, &str)] = &[
        ...
        (standard::INIT, "INIT"),
        (vendor::MODULE_INFO, "SCE_MODULE_INFO(orbis)"),
        (vendor::NEEDED_MODULE_ORBIS, "SCE_NEEDED_MODULE(orbis)"),
        (vendor::MODULE_ATTR_ORBIS, "SCE_MODULE_ATTR(orbis)"),
        (vendor::EXPORT_LIB_ORBIS, "SCE_EXPORT_LIB(orbis)"),
        (vendor::IMPORT_LIB_ORBIS, "SCE_IMPORT_LIB(orbis)"),
        (vendor::MODULE_INFO_PROSPERO, "SCE_MODULE_INFO(prospero)"),
        (
            vendor::NEEDED_MODULE_PROSPERO,
            "SCE_NEEDED_MODULE(prospero)",
        ),
        (vendor::MODULE_ATTR_PROSPERO, "SCE_MODULE_ATTR(prospero)"),
        (vendor::IMPORT_LIB_PROSPERO, "SCE_IMPORT_LIB(prospero)"),
        (vendor::EXPORT_LIB_PROSPERO, "SCE_EXPORT_LIB(prospero)"),
